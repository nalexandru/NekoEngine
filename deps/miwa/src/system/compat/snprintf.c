...
#if !defined(HAVE_SNPRINTF) || (HAVE_SNPRINTF == 0)
...
#  endif
                ...
                if (!justify_left && zero_padding) {
                        int n = (int)min_field_width - ((int)str_arg_l + (int)number_of_zeros_to_pad);
                        ...
                        * for numeric conversions required? */
                        if (number_of_zeros_to_pad <= 0) {
                                ...
                                * force it to be copied later in its entirety    */
                                ...
                                int n = (int)zero_padding_insertion_ind;
                                if (n > 0) {
                                        if (str_l < str_m) {
                                                size_t avail = str_m - str_l;
          ...
          { int n = (int)str_arg_l - (int)zero_padding_insertion_ind;
          if (n > 0) {
                  if (str_l < str_m) {
                          size_t avail = str_m - str_l;
