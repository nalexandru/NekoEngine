AR := ar
CC := gcc
PLATFORM_CFLAGS := -DOSX -I/usr/local/include -I/usr/local/include/freetype2 -I/usr/local/opt/openssl/include -std=c99 -c
PLATFORM_LDFLAGS := -L/usr/local/lib -L/usr/local/opt/openssl/lib -bind_at_load
PIC_CFLAGS := -fPIC
