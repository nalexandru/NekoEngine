...
{
	RS_PS_NONE = 0x0ULL,
	RE_PS_TOP_OF_PIPE = 0x00000001ULL,
	RE_PS_DRAW_INDIRECT = 0x00000002ULL,
	RE_PS_VERTEX_INPUT = 0x00000004ULL,
	RE_PS_VERTEX_SHADER = 0x00000008ULL,
	RE_PS_TESSELLATION_CONTROL_SHADER = 0x00000010ULL,
	RE_PS_TESSELLATION_EVALUATION_SHADER = 0x00000020ULL,
	RE_PS_GEOMETRY_SHADER = 0x00000040ULL,
	RE_PS_FRAGMENT_SHADER = 0x00000080ULL,
	RE_PS_EARLY_FRAGMENT_TESTS = 0x00000100ULL,
	RE_PS_LATE_FRAGMENT_TESTS = 0x00000200ULL,
	RE_PS_COLOR_ATTACHMENT_OUTPUT = 0x00000400ULL,
	RE_PS_COMPUTE_SHADER = 0x00000800ULL,
	RE_PS_TRANSFER = 0x00001000ULL,
	RE_PS_BOTTOM_OF_PIPE = 0x00002000ULL,
	RE_PS_HOST = 0x00004000ULL,
	RE_PS_ALL_GRAPHICS = 0x00008000ULL,
	RE_PS_ALL_COMMANDS = 0x00010000ULL,
	RE_PS_COPY = 0x100000000ULL,
	RE_PS_RESOLVE = 0x200000000ULL,
	RE_PS_BLIT = 0x400000000ULL,
	RE_PS_CLEAR = 0x800000000ULL,
	RE_PS_INDEX_INPUT = 0x1000000000ULL,
	RE_PS_VERTEX_ATTRIBUTE_INPUT = 0x2000000000ULL,
	RE_PS_PRE_RASTERIZATION_SHADERS = 0x4000000000ULL,
	RE_PS_TRANSFORM_FEEDBACK = 0x01000000ULL,
	RE_PS_CONDITIONAL_RENDERING = 0x00040000ULL,
	RE_PS_COMMAND_PREPROCESS = 0x00020000ULL,
	RE_PS_FRAGMENT_SHADING_RATE_ATTACHMENT = 0x00400000ULL,
	RE_PS_ACCELERATION_STRUCTURE_BUILD = 0x02000000ULL,
	RE_PS_RAY_TRACING_SHADER = 0x00200000ULL,
	RE_PS_FRAGMENT_DENSITY_PROCESS = 0x00800000ULL,
	RE_PS_TASK_SHADER_BIT = 0x00080000ULL,
	RE_PS_MESH_SHADER_BIT = 0x00100000ULL
};
...
{
	RE_PA_NONE = 0ULL,
	RE_PA_INDIRECT_COMMAND_READ = 0x00000001ULL,
	RE_PA_INDEX_READ = 0x00000002ULL,
	RE_PA_VERTEX_ATTRIBUTE_READ = 0x00000004ULL,
	RE_PA_UNIFORM_READ = 0x00000008ULL,
	RE_PA_INPUT_ATTACHMENT_READ = 0x00000010ULL,
	RE_PA_SHADER_READ = 0x00000020ULL,
	RE_PA_SHADER_WRITE = 0x00000040ULL,
	RE_PA_COLOR_ATTACHMENT_READ = 0x00000080ULL,
	RE_PA_COLOR_ATTACHMENT_WRITE = 0x00000100ULL,
	RE_PA_DEPTH_STENCIL_ATTACHMENT_READ = 0x00000200ULL,
	RE_PA_DEPTH_STENCIL_ATTACHMENT_WRITE = 0x00000400ULL,
	RE_PA_TRANSFER_READ = 0x00000800ULL,
	RE_PA_TRANSFER_WRITE = 0x00001000ULL,
	RE_PA_HOST_READ = 0x00002000ULL,
	RE_PA_HOST_WRITE = 0x00004000ULL,
	RE_PA_MEMORY_READ = 0x00008000ULL,
	RE_PA_MEMORY_WRITE = 0x00010000ULL,
	RE_PA_SHADER_SAMPLED_READ = 0x100000000ULL,
	RE_PA_SHADER_STORAGE_READ = 0x200000000ULL,
	RE_PA_SHADER_STORAGE_WRITE = 0x400000000ULL,
	RE_PA_TRANSFORM_FEEDBACK_WRITE = 0x02000000ULL,
	RE_PA_TRANSFORM_FEEDBACK_COUNTER_READ = 0x04000000ULL,
	RE_PA_TRANSFORM_FEEDBACK_COUNTER_WRITE = 0x08000000ULL,
	RE_PA_CONDITIONAL_RENDERING_READ = 0x00100000ULL,
	RE_PA_COMMAND_PREPROCESS_READ = 0x00020000ULL,
	RE_PA_COMMAND_PREPROCESS_WRITE = 0x00040000ULL,
	RE_PA_FRAGMENT_SHADING_RATE_ATTACHMENT_READ = 0x00800000ULL,
	RE_PA_SHADING_RATE_IMAGE_READ = 0x00800000ULL,
	RE_PA_ACCELERATION_STRUCTURE_READ = 0x00200000ULL,
	RE_PA_ACCELERATION_STRUCTURE_WRITE = 0x00400000ULL,
	RE_PA_FRAGMENT_DENSITY_MAP_READ = 0x01000000ULL,
	RE_PA_COLOR_ATTACHMENT_READ_NONCOHERENT = 0x00080000ULL,
};
