...
{ return Re_deviceProcs.CreateTransientTexture(Re_device, tci, 0, offset); }
static inline struct Buffer *Re_CreateTransientBuffer(const struct BufferCreateInfo *bci, BufferHandle location, uint64_t offset)
{ return Re_deviceProcs.CreateTransientBuffer(Re_device, bci, location, offset); }
