...
D3D12_CreateContext(struct RenderDevice *dev)
{
...
void
D3D12_ResetContext(struct RenderDevice *dev, struct RenderContext *ctx)
{
...
void
D3D12_DestroyContext(struct RenderDevice *dev, struct RenderContext *ctx)
{
...
void
D3D12_InitContextProcs(struct RenderContextProcs *p)
{
