...
GL_CreateRenderPassDesc(struct NeRenderDevice *dev, const struct NeAttachmentDesc *attachments, uint32_t count, const struct NeAttachmentDesc *depthAttachment,
...
void
GL_DestroyRenderPassDesc(struct NeRenderDevice *dev, struct NeRenderPassDesc *rp)
{
