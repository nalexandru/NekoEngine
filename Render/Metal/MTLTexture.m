...
bool
MTL_InitTexture(const char *name, struct Texture *tex, Handle h)
{
...
bool
MTL_UpdateTexture(struct Texture *tex, const void *data, uint64_t offset, uint64_t size)
{
	return false;
}

void
MTL_TermTexture(struct Texture *tex)
{
	/*struct TextureRenderData *trd = (struct TextureRenderData *)&tex->renderDataStart;
