...
#ifdef __GNUC__
#   define ALLOC_ALIGN      [[gnu::alloc_align(1), gnu::alloc_size(2)]]
#   define ASSUME_ALIGNED   [[gnu::assume_aligned(alignment)]]
#else
#   define ALLOC_ALIGN
#   define ASSUME_ALIGNED
#endif

ALLOC_ALIGN void *al_malloc(size_t alignment, size_t size);
ALLOC_ALIGN void *al_calloc(size_t alignment, size_t size);
...
ASSUME_ALIGNED inline T* assume_aligned(T *ptr) noexcept { return ptr; }
