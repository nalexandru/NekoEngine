/*
 * NX support (devkitA64) routines for PhysicsFS.
 *
 * Please see the file LICENSE.txt in the source's root directory.
 *
 *  This file written by Alexandru Naiman based on physfs_platform_unix.c & physfs_platform_posix.c by Ryan C. Gordon.
 */
...
{
	char *retval = allocator.Malloc(1024);
	snprintf(retval, 8, "romfs:/");
	return retval;
